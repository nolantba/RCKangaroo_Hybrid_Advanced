...
void GpuMonitor::PrintDetailedStats() {
    ...
    // Algo: line removed by user request (kept GPU Performance Monitor body above).
    // To restore the algorithm-feature checklist (SOTA+/Jacobian/LISSA/R2-4V/J1/J2/J3),
    // git-revert this block or copy from any earlier version of GpuMonitor.cpp.
