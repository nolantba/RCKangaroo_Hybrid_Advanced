...
// DISABLED — using classic uniform-random J1 in [2^(Range/2+1), 2^(Range/2+2)]
#define USE_LISSAJOUS 0
#endif

#ifndef USE_R2_4V
// DISABLED — also removes the Seq / V0-V3 distribution chart from the monitor banner
#define USE_R2_4V 0
#endif
// ============================================================================
